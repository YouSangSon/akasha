...
Akasha 운영자와 기여자를 위한 레퍼런스 문서입니다.

| 문서 | English | 설명 |
|------|---------|------|
| [architecture.ko.md](architecture.ko.md) | [architecture.md](architecture.md) | 컴포넌트 다이어그램, 데이터 흐름, 임베딩 provider, 마이그레이션 이력 |
...
| [self-hosted-operations.ko.md](self-hosted-operations.ko.md) | [self-hosted-operations.md](self-hosted-operations.md) | 자체 호스팅 배포의 백업, 복원, smoke-test runbook |

## 마이그레이션

| 문서 | English | 설명 |
|------|---------|------|
| [migrations/openai-to-transformers.ko.md](migrations/openai-to-transformers.ko.md) | [migrations/openai-to-transformers.md](migrations/openai-to-transformers.md) | OpenAI와 Transformers 임베딩 provider 간 전환 절차 |
